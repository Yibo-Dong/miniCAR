...
SOURCES = src/thirdParty/aiger/aiger.c \
			...
			src/sat/GlucoseSolver.cpp src/sat/ModelSolver.cpp \
...
OBJECTS = carsolver.o implysolver.o GlucoseSolver.o ModelSolver.o mainsolver.o main.o aiger.o $(SOLVER_OBJECTS) carChecker.o definition.o 
