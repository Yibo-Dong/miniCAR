...
OBJECTS = carsolver.o implysolver.o newpartialsolver.o mainsolver.o model.o main.o utility.o data_structure.o aiger.o\
...
OPTIONS= ${RANDOM_FLAG} ${CONTAINER_FLAG} ${FRESHUC_FLAG} ${FRESH_U_FLAG} ${PARTIAL_FLAG} ${SIMPU_INC_FLAG} ${ASSUM_FLAG} ${GUIDE_FLAG} ${SOLVER_FLAG} ${INTER_ORDER_FLAG} ${MAXNI_FLAG} ${COOK_FLAG} ${COOK_LIGHT_FLAG} $(SCORE_FLAG) $(SCORE_OPTION_FLAG) $(SCORE_REV_FLAG) $(FRONT_FLAG) $(SCORE_DECAY_FLAG) ${DEPTH_FLAG} ${STAT_FLAG}
