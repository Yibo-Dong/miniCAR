...
OPTIONS= ${RANDOM_FLAG} ${CONTAINER_FLAG} ${FRESHUC_FLAG} ${FRESH_U_FLAG} ${PARTIAL_FLAG} ${SIMPU_INC_FLAG} ${ASSUM_FLAG} ${GUIDE_FLAG} ${SOLVER_FLAG} ${INTER_ORDER_FLAG} ${MAXNI_FLAG} ${COOK_FLAG} ${COOK_LIGHT_FLAG} $(FRONT_FLAG) ${DEPTH_FLAG} ${STAT_FLAG}
